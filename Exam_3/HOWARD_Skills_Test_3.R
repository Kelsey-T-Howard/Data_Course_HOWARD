...
# I. Recreate the plot and save it

# First, load and clean FacultySalaries_1995.csv file
...
# III. Load the Juniper oils dataset and clean
...
# V. Show which compounds are significant in a generalized linear model
mod2 <- glm(data = coil,
...
# Note: The knitted htlml version of this script can also be found in my repository as well
